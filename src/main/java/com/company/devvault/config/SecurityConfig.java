...
public class SecurityConfig {
    ...
    @Value("${devvault.cors.allowed-origins}")
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtCookieFilter jwtCookieFilter) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/repository/maven/**").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/repository/maven/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/artifacts/**", "/api/search/**",
                                "/api/categories/**", "/api/analytics/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/artifacts", "/api/artifacts/*/versions").permitAll()
